...
|---|---|---|
| `ionicbond12203/open-ai-co-scientist-old` | Private loop repo. Automation, loop PRs, secrets, audit trails, and local worktrees live here. | Loop policy plus human review according to risk class. |
...
```bash
git remote -v
# origin   git@github.com:ionicbond12203/open-ai-co-scientist-old.git
...
1. Loop or local Codex work opens PRs inside `ionicbond12203/open-ai-co-scientist-old`.
